...
Choose which dataset you will use and create a list to store models:

```{r}
# dataMod <- ndGLM_scl2        # choose the data set for the models
# respones <- "misclass"
```

First, create functin that makes a series of univariate models from each predictor variable, and then prints their summaries:
