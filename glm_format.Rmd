...
Now, we load the data for the GLM. 
...
First, we will select only the nests with cameras, because the response variable is fate misclassification (difference between camera and field fate).
