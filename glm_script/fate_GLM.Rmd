...
if(UHisH == FALSE){
  ...
  makeU <- c(10258,10329,
             20251,20260,20264,20322,20424,20460,
             30932,30950
             )
  # makeU <- c(30932,30950)
...
```{r plots_tables1, child=if(missing_diag | separation) 'diagnostics.Rmd'}

```

```{r missing_sep1, child = if(corrplots1 | hist1 | tab1) 'fate_GLM_plots_tables.Rmd'}
...
```{r plots_tables2, child=if(tab2 | hist2 | corrplot2) 'fate_GLM_plots_tables.Rmd'}

```

```{r missing_sep2, child=if(missing_diag | separation) 'diagnostics.Rmd'}
